...
import { useMockWorkshopTypes } from '@/lib/hooks/useMockData'
import { WorkshopType } from '@/types'

export default function WorkshopsCreationDemo() {
  const { types, loading, error, addType, updateType, deleteType } = useMockWorkshopTypes()
      ...
      {selectedType && (
        <div className="mt-8 p-6 bg-blue-50 border border-blue-200 rounded">
          ...
          <p className="text-sm text-blue-700">
            Allez à l'onglet "Événements" pour créer des dates pour cet atelier
          </p>
        </div>
      )}
    </div>
